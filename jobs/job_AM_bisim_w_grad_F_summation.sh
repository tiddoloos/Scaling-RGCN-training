...
#SBATCH --job-name=AM_bisim_w_grad_F_summation
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#Run Program
python /home/loost/RGCN_MscThesis_TiddoLoos/main.py -dataset AM -i5 -w_grad False -exp summation -e_freeze False -sum bisim
