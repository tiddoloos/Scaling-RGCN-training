...
def calc_f1(pred: Tensor, x: Tensor, y: Tensor, avg='weighted') -> float:
    return f1_score(y, pred[x], average=avg, zero_division=0)

def evaluate(model: nn.Module, activation, traininig_data: Data, x: Tensor, y: Tensor, report=False) -> float:
